...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center section-container py-20"
    >
      <div className="grid md:grid-cols-[58%_42%] gap-20 items-center w-full">
        <div className="space-y-8">
          ...
          <div className="flex gap-5 pt-8 slide-in-left stagger-3">
            <Button
              onClick={() => scrollToSection("projects")}
              size="lg"
              className="bg-foreground text-background hover:bg-foreground/90 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-2xl px-8 py-6 text-base"
            >
              View My Work
            </Button>
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-2 border-foreground/20 text-foreground hover:border-foreground hover:bg-foreground hover:text-background transition-all duration-300 hover:scale-105 px-8 py-6 text-base"
            >
              Get In Touch
            </Button>
          </div>
        ...
        <div className="slide-in-right flex justify-center items-center">
          <div className="relative group">
            ...
            <img
              src="/shaunak_1.png"
              alt="Shaunak Pandit"
              className="relative w-full max-w-md mx-auto rounded-3xl shadow-2xl transform transition-all duration-500 group-hover:scale-[1.03] border-[3px] border-gray-900/20"
            />
          </div>
        </div>
      </div>
